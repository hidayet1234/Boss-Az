...
namespace Exam
{
    ...
    class Program
    {
        ...
        {
            CV cv1 = CreateCV();
            Worker worker1 = new Worker(1, "Ali", "Aliyev", "Baku", "1234567", 25, cv1);

            CV cv2 = CreateCV();
            Worker worker2 = new Worker(2, "Nigar", "Nigarkhanli", "Gence", "7654321", 30, cv2);

            Employer employer = new Employer(1, "Bakcell", "HR", "Baku", "9876543", 35);
